(function() {
    if ("undefined" == typeof window.powerbiframehandlerscript) {
            ...
            if (isReportPageLoadedEvent(event)) {
                ...
                setTimeout(function() {
                    if (iframe && iframe.parentNode.children.length > 1) {
                        switch (iframe.parentNode.getAttribute('data-pbi-resize-load-event')) {
                            case 'click':
                                showElement(iframe);
                                break;
                            case 'page-load':
        ...
        function prepareForResize(e, i, imgOnlys) {
            ...
            var mobileMinWidth = e[i].getAttribute("data-pbi-resize-mobile-min-width");
            var webImg = e[i].getAttribute('data-pbi-resize-img');
            var mobileImg = e[i].getAttribute('data-pbi-resize-m-img') || webImg;
            var webWidth = e[i].getAttribute("data-pbi-resize-width");
            var webHeight = e[i].getAttribute("data-pbi-resize-height");
            var webSrc = e[i].getAttribute("data-pbi-resize-rid");
            webSrc = webSrc ? pbiSrcSlug + webSrc : webSrc;
            var mobileWidth = e[i].getAttribute("data-pbi-resize-m-width");
            var mobileHeight = e[i].getAttribute("data-pbi-resize-m-height");
            var mobileSrc = e[i].getAttribute("data-pbi-resize-m-rid");
            mobileSrc = mobileSrc ? pbiSrcSlug + mobileSrc : mobileSrc;
            var loadEvent = e[i].getAttribute('data-pbi-resize-load-event');
            var header = false;
        ...
        function getStateName() {
            ...
            var imgAttr = node.getAttribute('data-pbi-resize-img');
